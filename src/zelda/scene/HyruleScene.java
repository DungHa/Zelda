...
public class HyruleScene extends ZeldaScene
{
    ...
    private Polygon leftPond, topLeftPond, leftWall;
...
*/
        ...
        int[] lpxpos = {42,42,465,465,116,92,92,34,1,1,44,42};
        int[] lpypos = {933,904,904,734,734,708,384,324,325,941,940,933};
        
        leftPond = new Polygon(lpxpos,lpypos, lpypos.length);
        
        
        int[] tlpxpos = {1,33,90,90,129,129,176,176,1,1};
        int[] tlpypos = {295,295,245,193,193,162,162,1,1,295};
        
        topLeftPond = new Polygon(tlpxpos,tlpypos,tlpypos.length);
        
        int[] lwxpos = {174,174,189,189,174,174,190,190,176,176,381,381,465,465,478,478,464,464,275,275,290,290,274,274,333,333,359,359,394,394,423,423,457,457,469,469,492,492,497,492,177};
        int[] lwypos = {160,192,192,358,358,496,496,567,567,663,663,710,710,645,645,591,591,564,564,496,496,358,358,184,184,262,262,279,279,263,263,279,279,264,264,295,295,272,272,168,160};
        
        leftWall = new Polygon(lwxpos,lwypos,lwypos.length);
        ...
        */
        ...
        gameObjects.add(new Bush(game, 226, 724));
        gameObjects.add(new Bush(game, 242, 724));
        gameObjects.add(new Bush(game, 258, 724));
        gameObjects.add(new Bush(game, 274, 724));
        gameObjects.add(new Bush(game, 290, 724));
        
        gameObjects.add(new Bush(game, 242, 708));
        gameObjects.add(new Bush(game, 226, 708));
        gameObjects.add(new Bush(game, 210, 708));
        
        gameObjects.add(new Bush(game, 158, 439));
        gameObjects.add(new Bush(game, 158, 455));
        ...
        gameObjects.add(new Guard(game, 18, 302, Direction.LEFT));
        gameObjects.add(new Guard(game, 18, 282, Direction.LEFT));
